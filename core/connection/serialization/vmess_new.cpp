...
namespace Qv2ray::core::connection
{
    ...
    {
        const static inline QStringList NetworkType{ "tcp", "http", "ws", "kcp", "quic" };
        const static inline QStringList QuicSecurityTypes{ "none", "aes-128-gcm", "chacha20-poly1305" };
        const static inline QStringList QuicKcpHeaderTypes{ "none", "srtp", "utp", "wechat-video", "dtls", "wireguard" };
        const static inline QStringList FalseTypes{ "false", "False", "No", "Off", "0" };
