#pragma once
#include "models/QvCoreSettings.hpp"
...
{
    struct QV2RAYBASE_EXPORT QvGraphPenConfig : public QObject
    {
        Q_OBJECT
    ...
    struct QV2RAYBASE_EXPORT Qv2rayConfig_Graph : public QObject
    {
    ...
    struct QV2RAYBASE_EXPORT Qv2rayConfig_UI : public QObject
    {
        Q_OBJECT
    ...
    struct QV2RAYBASE_EXPORT Qv2rayConfig_Plugin : public QObject
    {
    ...
    struct QV2RAYBASE_EXPORT Qv2rayConfig_Kernel : public QObject
    {
        Q_OBJECT
...
#undef VARNAME_VASSETSPATH
    ...
    struct QV2RAYBASE_EXPORT Qv2rayConfig_Update : public QObject
    {
        Q_OBJECT
    ...
    struct QV2RAYBASE_EXPORT Qv2rayConfig_Network : public QObject
    {
        Q_OBJECT
    ...
    struct QV2RAYBASE_EXPORT Qv2rayConfigObject : public QObject
    {
        Q_OBJECT
