...
namespace Qv2ray::base::config
{
    ...
    struct QV2RAYBASE_EXPORT __Qv2rayConfigObjectBase : public QObject
    {
        Q_OBJECT
    ...
    struct QV2RAYBASE_EXPORT SubscriptionConfigObject : public QObject
    {
        Q_OBJECT
    ...
    struct QV2RAYBASE_EXPORT GroupObject : public __Qv2rayConfigObjectBase
    {
        Q_OBJECT
    ...
    struct QV2RAYBASE_EXPORT ConnectionStatsEntryObject : public QObject
    {
        Q_OBJECT
    ...
    struct QV2RAYBASE_EXPORT ConnectionStatsObject
    {
    ...
    struct QV2RAYBASE_EXPORT ConnectionObject : public __Qv2rayConfigObjectBase
    {
        Q_OBJECT
    ...
    struct QV2RAYBASE_EXPORT __RouteConfig_Impl : public QObject
    {
        Q_OBJECT
      public:
    ...
    struct QV2RAYBASE_EXPORT RouteConfig : public QObject
    {
        Q_OBJECT
      public:
    ...
    struct QV2RAYBASE_EXPORT ForwardProxyConfig : public QObject
    {
        Q_OBJECT
      public:
    ...
    struct QV2RAYBASE_EXPORT ConnectionConfig : public QObject
    {
        Q_OBJECT
      public:
    ...
    struct QV2RAYBASE_EXPORT QvConfig_SystemProxy : public QObject
    {
        Q_OBJECT
      public:
    ...
    struct QV2RAYBASE_EXPORT Qv2rayConfig_ProtocolInboundBase : public QObject
    {
        Q_OBJECT
      public:
    ...
    struct QV2RAYBASE_EXPORT QvConfig_SocksInbound : public Qv2rayConfig_ProtocolInboundBase
    {
        Q_OBJECT
      public:
    ...
    struct QV2RAYBASE_EXPORT QvConfig_HttpInbound : public Qv2rayConfig_ProtocolInboundBase
    {
        Q_OBJECT
    ...
    struct QV2RAYBASE_EXPORT QvConfig_TProxy : public Qv2rayConfig_ProtocolInboundBase
    {
        Q_OBJECT
    ...
    struct QV2RAYBASE_EXPORT QvConfig_Inbounds : public QObject
    {
        Q_OBJECT
    ...
    struct QV2RAYBASE_EXPORT QvConfig_Outbounds : public QObject
    {
        Q_OBJECT
      public:
    ...
    struct QV2RAYBASE_EXPORT GroupRoutingConfig : __Qv2rayConfigObjectBase
    {
        Q_OBJECT
