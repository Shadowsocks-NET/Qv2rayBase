...
namespace Qv2ray::base::objects::complex
{
    ...
    struct QV2RAYBASE_EXPORT OutboundObjectMeta
    {
    ...
    QV2RAYBASE_EXPORT inline OutboundObjectMeta make_chained_outbound(const QList<QString> &chain, const QString &tag)
    {
        OutboundObjectMeta meta;
    ...
    QV2RAYBASE_EXPORT inline OutboundObjectMeta make_balancer_outbound(const QList<QString> &outbounds, const QString &type, const QString &tag)
    {
        OutboundObjectMeta meta;
    ...
    QV2RAYBASE_EXPORT inline OutboundObjectMeta make_external_outbound(const ConnectionId &id, const QString &tag)
    {
        OutboundObjectMeta meta;
    ...
    QV2RAYBASE_EXPORT inline OutboundObjectMeta make_normal_outbound(const OUTBOUND &outbound)
    {
        OutboundObjectMeta meta;
