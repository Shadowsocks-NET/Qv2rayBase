...
namespace Qv2ray::components::plugins
{
    ...
    QV2RAYBASE_EXPORT const QStringList GetPluginComponentsString(const QList<QV2RAY_PLUGIN_GUI_COMPONENT_TYPE> &types);
    QV2RAYBASE_EXPORT const QStringList GetPluginComponentsString(const QList<QV2RAY_PLUGIN_COMPONENT_TYPE> &types);
