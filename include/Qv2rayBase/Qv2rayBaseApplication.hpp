...
namespace Qv2ray
{
    ...
    struct QV2RAYBASE_EXPORT Qv2rayStartupArguments
    {
        enum Argument
        {
            NORMAL = 0,
    ...
    class QV2RAYBASE_EXPORT Qv2rayApplicationInterface
    {
      public:
    ...
    inline QV2RAYBASE_EXPORT Qv2rayApplicationInterface *QvCoreApplication = nullptr;
} // namespace Qv2ray
